...
public class DateUtil {
     ...
     * @return
     */
    public static Date GenerateDate(String beginDate, String endDate) {
        try {
            SimpleDateFormat simpleDateFormat = new SimpleDateFormat(dateFormat4);
            Date start = simpleDateFormat.parse(beginDate);// 构造开始日期              
            Date end = simpleDateFormat.parse(endDate);// 构造结束日期    
